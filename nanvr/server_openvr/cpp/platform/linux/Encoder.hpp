...
public:
    ...
    void initEncoding() {
        ...
        auto& avHwCtx = *new nanvr::HWContext(vkCtx);

        auto out = renderer.get().getOutput();

        // TODO: Fix Nvidia

        // auto framCtx = new nanvr::VkFrameCtx(aCtx, *(vk::ImageCreateInfo*)&out.imageCI);

        auto frame = new nanvr::VkFrame(
